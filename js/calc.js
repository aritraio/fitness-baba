...
/* ══════════════════════════════════════════════════════
   CALCULATIONS
══════════════════════════════════════════════════════ */
export const bmi = () => S.weight / Math.pow(S.height/100, 2);
export const bmr = () => S.gender==='Male'
  ? (10*S.weight)+(6.25*S.height)-(5*S.age)+5
  : S.gender==='Female'
    ? (10*S.weight)+(6.25*S.height)-(5*S.age)-161
    : (10*S.weight)+(6.25*S.height)-(5*S.age)-78;
export const tdee = () => bmr() * S.actMult;
export const daily = () => tdee() + S.goal;
